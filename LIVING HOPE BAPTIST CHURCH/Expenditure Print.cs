...
{
    public partial class Expenditure_Print : Form
    {
        public Expenditure_Print()
        {
            InitializeComponent();
        }

        private void Expenditure_Print_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'churchProjectDataSet7.Expenditure' table. You can move, or remove it, as needed.
            this.expenditureTableAdapter.Fill(this.churchProjectDataSet7.Expenditure);

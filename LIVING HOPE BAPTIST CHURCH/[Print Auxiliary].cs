...
{
    public partial class _Print_Auxiliary_ : Form
    {
        public _Print_Auxiliary_()
        {
            InitializeComponent();
        }

        private void _Print_Auxiliary__Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'auxiliary.auxiliary' table. You can move, or remove it, as needed.
            this.auxiliaryTableAdapter.Fill(this.auxiliary.auxiliary);
